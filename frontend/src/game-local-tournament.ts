...
const localTour_matchmaking_popup = `
	<div id="localTour_matchmaking_popup" class="border border-2 border-white flex flex-col justify-center items-center hidden fixed bg-black bg-opacity-90 inset-0" style="background-color: rgba(0,0,0,0.9)">
		<div id="localTour_matchmaking_popup_screen" class="bg-black border border-2 border-white w-[70%] h-[70%] flex flex-col justify-center items-center">
			...
			<!-- Winner display -->
			<div id="localTour_matchmaking_winnerdiv" class="text-center hidden">
				<h1 class="text-[30px] text-white">Winner:</h1>
				<div id="localTour_matchmaking_finalwinner2" class="text-[25px] font-bold text-white"></div>
				<h1 class="text-[30px] text-white">Congratulations! 🎉🎉</h1>
			</div>
			
			<button id="localTour_open_game" class="border-2 border-white text-white px-4 py-2 text-[18px]">START MATCH</button>
			<button id="localTour_close_finalwinner_popup" class="hidden border-2 border-white text-white px-4 py-2 mt-[5px] text-[18px]">Close Tournement</button>
		</div>
	</div>
`
